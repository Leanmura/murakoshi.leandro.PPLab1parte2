...
/** \brief Pide un telefono, dando la opcion de elegir entre un telefono fijo(nnnn-nnnn) o celular(nn-nnnn-nnnn)
 *
 * \param telefono[] char Array donde va a de volver el telefono
 * \param len int tamanio del array
 * \param intentos int cantidad de intentos totales
 * \return int int devuelve 1 si esta todo ok, o 0 si hay algun error
 *
 */
